...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="admin/dosen/create.php" class="nav-item nav-link">Order</a>
                    </div>
                </div>
            </nav>
        </div>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white disabled" href="harga.php">Harga</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="container">
            <h6 class="text-secondary text-uppercase text-center font-weight-medium mb-3">Harga Jasa Laundry Kami</h6>
            <h1 class="display-4 text-center mb-5">Harga Terbaik</h1>
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 250px; height: 250px; border: 10px solid #ffffff;">
                            <h3 class="text-white">Cuci Bersih</h3>
                            <h1 class="display-4 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rp</small>10k<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ kg</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <ul>
                                <li>Dicuci Sampai Bersih</li>
                                <li>Hasil Cucian Wangi</li>
                                <li>Diantar Dengan Selamat</li>
                            </ul>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 250px; height: 250px; border: 10px solid #ffffff;">
                            <h3 class="text-white">Cuci Kering</h3>
                            <h1 class="display-4 text-white mb-0">
                        ...
                        <div class="d-flex flex-column align-items-center py-3">
                            <ul>
                                <li>Dicuci Sampai Bersih</li>
                                <li>Hasil Cucian Wangi</li>
                                <li>Pakaian Kering</li>
                                <li>Pakaian Disetrika</li>
                                <li>Diantar Dengan Selamat</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 250px; height: 250px; border: 10px solid #ffffff;">
                            <h3 class="text-white">Dua Hari jadi</h3>
                            <h1 class="display-4 text-white mb-0">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">Rp</small>35k<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ kg</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <ul>
                                <li>Dua Hari Beres</li>
                                <li>Dicuci Sampai Bersih</li>
                                <li>Hasil Cucian Wangi</li>
                                <li>Pakaian Kering</li>
                                <li>Pakaian Disetrika</li>
                                <li>Diantar Dengan Cepat</li>
                                <li>Diantar Dengan Selamat</li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- Back to Top -->
    <a href="harga.php" class="btn btn-lg btn-primary back-to-top"><i class="fa fa-angle-double-up"></i></a>
