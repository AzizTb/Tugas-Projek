...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn text-white disabled" href="pelayanan.php">Pelayanan</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="container">
            ...
            <h1 class="display-4 text-center mb-5">Yang Kita Tawarkan</h1>
            <div class="row">
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Mencuci</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Mengeringkan</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Mencuci Pakaian</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Mencuci Tirai</h4>
                    </div>
                </div>
            </div>
        </div>
